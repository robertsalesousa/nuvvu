...
import { Home, Compass, Calendar, User, LayoutDashboard, Settings } from 'lucide-react';

export default function BottomNavigation({ onNavigate, currentPage, userRole }) {
  const clientNav = [
    { label: 'Início', id: 'home', icon: Home },
    { label: 'Explorar', id: 'explore', icon: Compass },
    { label: 'Reservas', id: 'bookings', icon: Calendar },
